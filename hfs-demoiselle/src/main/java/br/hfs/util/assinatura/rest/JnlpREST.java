...
public class JnlpREST {
	...
	private String generate(String identificador, String servico) {
		...
		sb.append("<jar href=\"demoiselle-certificate-core-" + versao + ".jar\"/>\n");
		sb.append("<jar href=\"demoiselle-certificate-signer-" + versao + ".jar\"/>\n");
		sb.append("<jar href=\"demoiselle-certificate-criptography-" + versao + ".jar\"/>\n");
		sb.append("<jar href=\"demoiselle-certificate-ca-icpbrasil-" + versao + ".jar\"/>\n");
		sb.append("<jar href=\"demoiselle-certificate-desktop-" + versao + ".jar\"/>\n");
		...
		sb.append("<property name=\"jnlp.downloadFromUrl\" value=\"").append(url).append("/anexos/").append("\"/>\n");
