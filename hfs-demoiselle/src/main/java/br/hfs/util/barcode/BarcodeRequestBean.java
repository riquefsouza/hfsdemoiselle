...
public class BarcodeRequestBean {
	private static Logger log = Logger.getLogger(BarcodeRequestBean.class);
	...
	public boolean isSVG() {
		return MimeTypes.MIME_SVG.equals(MimeTypes.expandFormat(getFormat()))
				|| (getFormat() == null) || (getFormat().length() == 0);
	}
	...
	public String toURL() {
		...
		try {
			...
			sb.append(java.net.URLEncoder.encode(msg, "UTF-8"));
			...
			if (humanReadableFont != null) {
				...
				sb.append("=");
				sb.append(java.net.URLEncoder
						.encode(humanReadableFont, "UTF-8"));
			}
