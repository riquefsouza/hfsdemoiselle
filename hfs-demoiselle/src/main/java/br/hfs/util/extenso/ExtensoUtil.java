...
public class ExtensoUtil implements Serializable {
     ...
     * @since JDK 1.5
     */
    public ExtensoUtil(BigDecimal dec) throws NumberFormatException {
        this();
        setNumber(dec);
    }
     ...
     * @since JDK 1.5
     */
    public ExtensoUtil(double dec) throws NumberFormatException {
        this();
        setNumber(dec);
    }
    ...
    public String DecimalFormat() {
        ...
        String retorno = sym.getCurrencySymbol() + " " + formatter.toString(); 
        formatter.close();
     ...
     *         quantidade de dígitos do primeiro grupo for maior que 1.
     * @since JDK 1.5
     */
     ...
     *
     * @param divisor
     *            A característica a ser adicionada ao atributo Remainder.
     * @since JDK 1.5
     */
     ...
     *
     * @param numero
     *            Parte inteira do número (do valor monetário).
     * @param escala
     *            Parte centezimal do número (dos centavos).
